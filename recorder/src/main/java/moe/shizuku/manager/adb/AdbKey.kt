 ...
 *
 * Local adaptations:
 *  - rikka.core.ktx.unsafeLazy replaced with Kotlin lazy
 *  - androidx.core.content.edit KTX extension replaced with plain SharedPreferences.edit()
 */
